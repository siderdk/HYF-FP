        ...
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.socials}>
              <a
                href="https://www.linkedin.com/company/hackyourfuture-denmark"
                className={styles.socialLink}
                aria-label="HYF Denmark on LinkedIn"
                target="_blank"
                rel="noopener noreferrer"
              >
                <LinkedInIcon />
              ...
              <a
                ...
                className={styles.socialLink}
                aria-label="HYF Denmark on Instagram"
                target="_blank"
                rel="noopener noreferrer"
              >
                <InstagramIcon />
          ...
          {/* Column 3: About */}
          <div className={styles.col}>
            <h3 className={styles.colTitle}>About HYF Aarhus</h3>
            <p className={styles.aboutText}>
              HackYourFuture Denmark · Aarhus
            </p>
            <p className={styles.aboutText}>Non-profit organization</p>
